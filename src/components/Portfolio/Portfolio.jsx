...
function Portfolio() {
    return (
        <section className="portfolio">
            ...
            <div>
                <a className="portfolio__portfolio link" href="https://keeonezy.github.io/how-to-learn/index.html" target="_black">
                ...
                <a className="portfolio__portfolio link" href="https://keeonezy.github.io/russian-travel/index.html" target="_black">
                    <p className="portfolio-portfolio-description">Адаптивный сайт</p>
                    <img src={studentArrow} alt="Стрелка для перехода" className="portfolio__arrow" />
                </a>
                <a className="portfolio__portfolio link" href="https://keeonezy.github.io/mesto-react/index.html" target="_black">
