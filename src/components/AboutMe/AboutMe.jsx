        ...
        <section className="about-me">
            ...
            <div className="about-me__container">
                <div className="about-me__container-left">
                    ...
                    <p className="about-me__description">Я родился в Оренбурге, закончил факультет экономики ОГУ. Я люблю слушать музыку. Отдыхать от суеты люблю в кино. Начать изучать фронтенд разработку в 2022 году. Уже прошел 1 год с того момента, я получил новые навыки. Теперь их использую</p>
